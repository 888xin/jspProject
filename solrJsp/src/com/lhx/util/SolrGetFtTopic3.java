 ...
 * @Description
 */
public class SolrGetFtTopic3 {
//    private static final String SOLR_URL = "http://localhost:8080/solr/ft";
    ...
    public String queryAll(String htmlWord){
        ...
        params.set("q","topicName:"+htmlWord);
...
//        params.set("f1","topic_name,visit_num");
        ...
        try {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                map.put("topicName",document.getFieldValue("topicName") );
                map.put("visitNum", document.getFieldValue("visitNum"));
                listWord.add(map);
            }
